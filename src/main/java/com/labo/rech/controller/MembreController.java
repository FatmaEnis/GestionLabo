...
public class MembreController {
	...
	public ResponseEntity<Optional<Membre>> getMembreById(@PathVariable(value = "id") Integer MembreId) {
	...
	public void updateMembre(@PathVariable(value = "id") Integer id ,@Valid @RequestBody Membre membre) throws RecordNotFoundException {
		membre.setId(id);
	...
	public Map<String, Boolean> deleteMembre(@PathVariable(value = "id") Integer MembreId)
